...
test('buildFilter with simple filter', t => {
  ...
  t.deepEqual(buildFilter(query), 'moment=2017-01-09 22:15:06;name=foo;some=;value=3');
...
test('buildFilter with simple deep and many condition filter', t => {
  ...
  t.deepEqual(buildFilter(query), 'deep.one=5;deep.tow=bar;many=1;many=baz;moment=2017-01-09 22:15:06;name=foo;value=3');
