...
test('parseQueryString', function (t) {
  ...
  t.deepEqual(parseQueryString('a=1&b=tow&c=true'), { a: 1, b: 'tow', c: true }, 'should parse simple query');

  t.deepEqual(parseQueryString('a=1&b=3three&a=tow&c=three &e=qwerty%20123%20&foo.bar= baz&a=&a=4,,five&' + 'bool=true&f=&notBool= true'), {
...
//# sourceMappingURL=parseQueryString.test.js.map