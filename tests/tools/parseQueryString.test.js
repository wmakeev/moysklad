...
test('parseQueryString', t => {
  ...
  t.equal(
    parseQueryString(),
    undefined,
    'should return undefined with undefined'
  )
  t.equal(
    parseQueryString(null),
    undefined,
    'should return undefined with null'
  )
  t.equal(
    parseQueryString(''),
    undefined,
    'should return undefined with empty string'
  )
  t.equal(
    parseQueryString(' '),
    undefined,
    'should return undefined with space string'
  )
  ...
  t.deepEqual(
    parseQueryString(
      'a=1&b=3three&a=tow&c=three &e=qwerty%20123%20&foo.bar= baz&a=&a=4,,five&' +
