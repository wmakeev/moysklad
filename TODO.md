...
- [ ] Добавить пример кода обработки ошибок при массовом обновлении сущностей

- [ ] В POST при флаге `muteErrors` можно получить другой вид ошибки. Например timeout и метод вернет `undefined`. Выходит, нужно конкретизировать тип ошибки в `muteErrors`? Или нужен другой флаг?
