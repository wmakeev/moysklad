...
var parseQueryString = require('../tools/parseQueryString');
...
module.exports = function parseUri(uri) {
  ...
  var path = normalizeUrl(pathStr).split(/\//g);
  var query = parseQueryString(queryStr);
